...
def test_getStatistics():
    ...
    correctStat = "min: 12 max: 643 mean: 201.3 StdDev: 194.54 iqr: 202.5 total: 2013"
...
def test_getStatistics2():
    ...
    correctStat = "min: 5 max: 55 mean: 25.86 StdDev: 16.45 iqr: 23.5 total: 181"
    assert statString == correctStat
...
def test_getStatistics3():
    ...
    numList = [
        ...
        365]
    statString = statistics.get_statistics(numList)
    correctStat = "min: 5.0 max: 1000.0 mean: 173.04 StdDev: 254.68 iqr: 152.75 total: 2768.7"
    assert statString == correctStat
...
def test_combine_statistics():
    ...
    correctStat = [
        "variablesmin: 1 max: 4 mean: 2.5 StdDev: 1.12 iqr: 1.5 total: 10",
        "methodsmin: 1 max: 2 mean: 1.5 StdDev: 0.5 iqr: 1.0 total: 6",
        "linesmin: 10 max: 65 mean: 37.75 StdDev: 22.86 iqr: 39.25 total: 151",
        "classesmin: 1 max: 2 mean: 1.25 StdDev: 0.43 iqr: 0.25 total: 5"]
